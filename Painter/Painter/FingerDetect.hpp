...
int lowH = 0, lowS = 90, lowV = 0;
int highH = maxH, highS = maxValue, highV = 150;
...
public:
    ...
    {
        medianBlur(this->frame, HsvOutput.frame, 5);
    ...
    void detectObject()
    {
        ...
        erode(this->frame, this->frame, element);
        morphologyEx(this->frame, this->frame, MORPH_OPEN, element);
        dilate(this->frame, this->frame, element);
        morphologyEx(this->frame, this->frame, MORPH_OPEN, element);
